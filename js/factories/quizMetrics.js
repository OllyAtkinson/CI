            ...
            function getA(){
                ...
                for(var i = 0; i < DataService.quizQuestions.length; i++){
                    if(DataService.quizQuestions[i].selected === DataService.A[i]){
                        DataService.quizQuestions[i].correctA = true;
                        quizObj.ACorrect++;
                    }else{
                        DataService.quizQuestions[i].correctA = false;
                    }
                }
            }
            ...
            function getP(){
                ...
                for(var i = 0; i < DataService.quizQuestions.length; i++){
                    if(DataService.quizQuestions[i].selected === DataService.P[i]){
                        DataService.quizQuestions[i].correctP = true;
                        quizObj.PCorrect++;
                    }else{
                        DataService.quizQuestions[i].correctP = false;
                    }
                }
            }
            ...
            function getE(){
                ...
                for(var i = 0; i < DataService.quizQuestions.length; i++){
                    if(DataService.quizQuestions[i].selected === DataService.E[i]){
                        DataService.quizQuestions[i].correctE = true;
                        quizObj.ECorrect++;
                    }else{
                        DataService.quizQuestions[i].correctE = false;
                    }
                }
            }
            ...
            function getI(){
                ...
                for(var i = 0; i < DataService.quizQuestions.length; i++){
                    if(DataService.quizQuestions[i].selected === DataService.I[i]){
                        DataService.quizQuestions[i].correctI = true;
                        quizObj.ICorrect++;
                    }else{
                        DataService.I[i].correctI = false;
                    }
                }
            }
